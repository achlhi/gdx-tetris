...
public class Assets {
	...
	public static void load(){
		...
		texture = new Texture(Gdx.files.internal("tetris/game-screen.png"));
		...
		texture = new Texture(Gdx.files.internal("tetris/main-screen.png"));
		texture.setFilter(TextureFilter.Linear, TextureFilter.Linear);
		...
		texture = new Texture(Gdx.files.internal("tetris/game-over.png"));
		texture.setFilter(TextureFilter.Linear, TextureFilter.Linear);
		...
		texture = new Texture(Gdx.files.internal("tetris/game-pause.png"));
		texture.setFilter(TextureFilter.Linear, TextureFilter.Linear);
		...
		texture = new Texture(Gdx.files.internal("tetris/block.png"));
		texture.setFilter(TextureFilter.Linear, TextureFilter.Linear);
		
		block = new TextureRegion(texture, 1, 1, 18, 18);
		
		font = new BitmapFont(Gdx.files.internal("tetris/ubuntu-mono-48.fnt"),
		         Gdx.files.internal("tetris/ubuntu-mono-48.png"), false);
	}
